        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="w-4 h-4 text-teal border-gray-300 rounded" />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-navy text-white font-semibold rounded-lg hover:bg-navy-dark transition-colors disabled:opacity-50"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/merchant/register" className="text-teal font-medium hover:text-teal-dark">
                Apply now
              </Link>
            </p>
          </div>
